...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'editable_waypoint_manager=hotel_path_planner.editable_waypoint_manager:main',
            'fixed_waypoint_mission=hotel_path_planner.fixed_waypoint_mission:main',
            'fixed_waypoint_route=hotel_path_planner.fixed_waypoint_route:main',
            'fixed_waypoint_planner=hotel_path_planner.fixed_waypoint_planner:main',
